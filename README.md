...
- `src/components/` – Data-only component resources such as `StatsComponent`, `TraitComponent`, and `Trait` that encode modular attributes for EntityData manifests.【F:src/components/StatsComponent.gd†L1-L26】【F:src/components/TraitComponent.gd†L1-L38】【F:src/components/Trait.gd†L1-L19】
