...
## Defines the valid targets for a skill or action.
enum TargetType {
    SELF,
    ENEMY,
    ALLY,
...
## Defines the broad category of a skill.
enum SkillCategory {
    MELEE,
    RANGED,
    DEFENSE,
...
## Defines the rarity classification of a skill.
enum SkillRarity {
    BASIC,
    COMMON,
    UNIQUE,
...
## Defines the type of weapon required for a skill, if any.
enum WeaponType {
    NONE,
    SWORD,
    AXE,
